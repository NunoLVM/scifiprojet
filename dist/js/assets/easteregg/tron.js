...
// Pause/Resume via postMessage e blur/focus
let externalPaused = false;
window.addEventListener('message', (e) => {
  if (e.data === 'pause')   externalPaused = true;
  if (e.data === 'resume')  externalPaused = false;
});
...
window.addEventListener('blur', () => externalPaused = true);
// window.addEventListener('focus', () => externalPaused = false);
      ...
      async function Draw(){
        if (externalPaused) {
          // só desenha o overlay de PAUSED
